...
export class CustomizeView extends LitElement {
    ...
    static properties = {
        ...
        onSendScreenshotsChange: { type: Function },
    ...
    handleSendScreenshotsToggle(e) {
        this.sendScreenshotsEnabled = e.target.checked;
        localStorage.setItem('sendScreenshotsEnabled', this.sendScreenshotsEnabled ? 'true' : 'false');
        this.onSendScreenshotsChange(this.sendScreenshotsEnabled);
    }
